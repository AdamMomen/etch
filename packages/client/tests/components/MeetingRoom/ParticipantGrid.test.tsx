...
vi.mock('@/components/MeetingRoom/RemoteParticipantVideo', () => ({
...
vi.mock('@/components/MeetingRoom/RemoteParticipantAudio', () => ({
  RemoteParticipantAudio: ({ participantId }: { participantId: string }) => (
    <div data-testid={`remote-audio-${participantId}`} />
  ),
}))

vi.mock('@/components/MeetingRoom/LocalVideoPreview', () => ({
