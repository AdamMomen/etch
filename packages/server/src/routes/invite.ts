...
inviteRouter.get('/:roomId', (c) => {
  ...
  const deepLink = `nameless://room/${roomId}`
...
<head>
  ...
  <title>Join Meeting - NAMELESS</title>
  <style>
    * {
      margin: 0;
      padding: 0;
...
<body>
  <div class="container">
    ...
    <div class="status" id="status">
      ...
      <p class="status-text">Opening NAMELESS app...</p>
    </div>
  ...
  <script>
    (function() {
      ...
      function checkFallback() {
        ...
        if (elapsed > 2500) {
          statusEl.innerHTML = '<p class="status-text">App not detected</p>';
        }
      }
