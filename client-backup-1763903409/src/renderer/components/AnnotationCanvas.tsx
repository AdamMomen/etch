...
import { normalizeCoordinates, denormalizeCoordinates } from '../utils/coordinateUtils';
...
const AnnotationCanvas: React.FC<AnnotationCanvasProps> = ({
  ...
  useEffect(() => {
    ...
    const handleData = (payload: Uint8Array, participant?: any) => {
      try {
        const message: AnnotationMessage = JSON.parse(new TextDecoder().decode(payload));
